...
export default function Identity() {
  ...
  const steps = [
      ...
      description: function () {
        return (
          <RadioGroup name="type-of-accident" onChange={handleRadioChange}>
            ...
            <MyFormControlLabel value="ZA" label="ZA" control={<Radio />} />
          </RadioGroup>
        );
      },
    },
    ...
    // Trzeci krok
    {
      label: "Spytaj o",
      description: function () {
        if (secondValue === "Właściciel") {
          return <p>Wybrałeś właściciel</p>;
        } else if (secondValue === "Sprawca") {
          return <p>Wybrałeś Sprawca</p>;
        } else if (secondValue === "Zgłaszający") {
          return <p>Wybrałeś Zgłaszający</p>;
